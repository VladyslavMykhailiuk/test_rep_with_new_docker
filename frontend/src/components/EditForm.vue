...
export default {
  ...
  methods:{
    validateInput() {
      ...
      axiosInstance.post('/editPost.php',valForm,{
        params:{
          "id":id,
        }
      }).then( (response) => {
  ...
  mounted(){
    ...
    axiosInstance.get(`post.php`,{
      ...
      this.forValidation.title = this.post[0].title;
      this.forValidation.annotation = this.post[0].annotation;
      this.forValidation.content = this.post[0].content;
      this.forValidation.email = this.post[0].email;
      this.forValidation.views = this.post[0].views;
      this.forValidation.date = this.post[0].date;
      this.forValidation.publish_in_index = this.post[0].publish_in_index;
      this.forValidation.category = this.post[0].category_id;
    });
  }
}
</script>
